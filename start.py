...
async def _production_security_middleware(request, call_next):
    ...
    # La autocausacion de expensas al abrir /liquidador es intencional en este ERP:
    # mantiene el registro de cuotas actualizado hasta la fecha de corte. La ruta
    # original del liquidador conserva ademas la posibilidad de corregir los datos.
